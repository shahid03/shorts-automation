...
module.exports = {
  ...
  imageGen: {
    ...
    comfyui: {
      ...
      checkpoint:
        process.env.COMFYUI_CHECKPOINT || "realisticStockPhoto_v20.safetensors",
  ...
  captions: {
    ...
    url:
      process.env.CAPTION_SERVICE_URL ||
      "http://localhost:8080/v1/video/caption",
  ...
  storage: {
    ...
    googleDrive: {
      ...
      folders: {
        voiceovers:
          process.env.GD_VOICEOVER_FOLDER ||
          "1ENYaAnwT4f8O5sr2PVXQqL-Go9TzJQto",
        images:
          process.env.GD_IMAGES_FOLDER || "1oRjIYchXEVE5PMzx6bL6cmHGlua1UA_B",
        finals:
          process.env.GD_FINALS_FOLDER || "1AnQ00_qdqVui3Ufh4BOahEYWfPbQ3_P_",
      },
    },
    minio: {
  ...
  publish: {
    ...
    instagram: {
      ...
      uploadUrl:
        process.env.INSTAGRAM_UPLOAD_URL ||
        "https://api.upload-post.com/api/upload",
    },
  },
  ...
  sheets: {
    ...
    credentialsPath:
      process.env.SHEETS_CREDENTIALS_PATH || "./config/google-credentials.json",
    spreadsheetId:
      process.env.SHEETS_ID || "1Rojlh1YfWkpuow18hOtW_j3_Ku43_cG6t-RlSCGj2Lk",
  ...
  content: {
    keywords:
      process.env.CONTENT_KEYWORDS || "stoic, ancient rome, roman architecture",
    themes: (
